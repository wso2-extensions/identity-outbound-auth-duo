...
To get started with the authenticator, read
[Duo Security Authenticator Documentation](https://github.com/wso2-extensions/identity-outbound-auth-duo/blob/3.x.x/docs/README.md).
