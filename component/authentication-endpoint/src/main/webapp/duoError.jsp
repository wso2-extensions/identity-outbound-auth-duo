    ...
    <%
        ...
        if (Boolean.parseBoolean(request.getParameter(Constants.AUTH_FAILURE))) {
            ...
            if (request.getParameter(Constants.AUTH_FAILURE_MSG) != null) {
                ...
                if (errorMessage.equalsIgnoreCase("authentication.fail.message")) {
                ...
                } else if (errorMessage.equalsIgnoreCase("user.not.registered")) {
                    errorMessage = "Couldn't get the user information. User may not registered in Duo. Authentication failed.";
                    ...
                    errorMessage = "Couldn't get the verified user name. Authentication Failed.";
                }
            }
        }
    %>
